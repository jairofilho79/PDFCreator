...
const 
   ...
   nomeDosAlunos = "",
   matricula = "",
   membroConvidado = "Josivaldo Pereira dos Santos",
   tituloOrientador = "dfafasfa fafasasf",
   orientador = "Josivaldo Pereira dos Santos",
   dia = "",
   mes = "",
   ano = "",
...
doc.pipe(fs.createWriteStream('credenciamento.pdf'));

doc.font('Times-Bold')
   .fontSize(15)
   .text(`REQUERIMENTO DE CREDENCIAMENTO PARA PARTICIPAÇÃO DE BANCA`
      ,80, 50,{
         align: 'center',
      });
...
doc.fontSize(12)
   .text(`Nestes termos, peço deferimento.`
      ,100, 210,{
         align: 'left',
      });
...
doc.fontSize(12)
   .text(`Art. 94. O TCC será defendido em sessão pública, perante banca examinadora  constituída  de,  no  mínimo,  dois  membros,  sendo  um  deles,  obrigatoriamente,  o orientador, que presidirá a sessão.\n
