...
const 
   ...
   nomeDosAlunos = 
   `
   adfasdfa fasfasfda sfasfasfda
   jsdhvlsj askdlnhasdasd asdasd
   `,
   tituloOrientador = "fgbdf ewfwf",
   orientador = "fwfwdfwfwef wefwfw vwefwfwfw",
   tituloCoOrientador = "",
   ano = "2019",
   coOrientador = "";
...
doc.pipe(fs.createWriteStream('cd.pdf'));
...
doc.fontSize(10)
   .text(`Orientador: ${tituloOrientador} ${orientador}`
      ,100, 270,{
         align: 'left'
      });

doc.fontSize(10)
   .text(`Co-Orientador: ${tituloCoOrientador} ${coOrientador}`
      ,100, 290,{
         align: 'left'
      });
